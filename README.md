...
# Dự Án Dịch Ngược & Khôi Phục Mã Nguồn Plugin SketchUp Đang Sử Dụng rubyencoder

Dự án này tập trung vào việc dịch ngược (decompile) bytecode Ruby YARV 2.7, khôi phục mã nguồn nghiệp vụ hoàn chỉnh của plugin SketchUp và thực hiện các quy trình kiểm thử tĩnh tự động để đảm bảo code sạch lỗi cú pháp (`Syntax OK`) và tuân thủ đúng SketchUp API.
